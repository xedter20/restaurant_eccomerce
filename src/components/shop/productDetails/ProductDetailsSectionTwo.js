...
const ProductDetailsSectionTwo = (props) => {
  ...
  return (
    <Fragment>
      ...
      <div className="m-4 md:mx-8 md:my-6 flex justify-center capitalize font-medium tracking-widest bg-white border-t border-b text-gray-800 px-4 py-4 space-x-4">
        <div>
          <span>Category :</span>
